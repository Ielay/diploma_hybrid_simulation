...
while robot.step(TIME_STEP) != -1:
    ...
    light_max = max(light)
    print('Robot {0} max light: {1}'.format(robot_name, light_max))
    ...
    for i in range (k):
        ...
        if bearingn [i][1] > 0:
            ...
            k_i_w += 1 
    if k_i_w != 0:
        cos_sum_sr_w = cos_sum_w*q_sum/k_i_wии 
